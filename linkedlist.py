...
# I got a different error message than the test was looking for:
# AttributeError: 'NoneType' object has no attribute 'next'
# I could not think of any other way to get the right results
# figured try/except was the best way to handle a know error situation
#it still fails the homework test, but it fails politely.
                try:
                    current = current.next
                except:
                    return "Exception: List not long enough"
            else:
                return current
